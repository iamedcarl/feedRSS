...
ActiveRecord::Schema.define(version: 20170826193512) do
  ...
  create_table "saved_articles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["article_id"], name: "index_saved_articles_on_article_id", unique: true
    t.index ["user_id", "article_id"], name: "index_saved_articles_on_user_id_and_article_id", unique: true
    t.index ["user_id"], name: "index_saved_articles_on_user_id", unique: true
  end
